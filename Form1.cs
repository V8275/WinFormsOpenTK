...
namespace WinFormsOpenTK
{
    public partial class Form1 : Form
    {
        ...
        private void InitializeScene()
        {
            ...
            // —оздаем первый источник света (как был раньше)
            ...
            // ƒобавл€ем второй источник света (например, с другой стороны)
            ...
            // ƒобавл€ем третий источник света (сверху)
